...
<div><strong>68276 Refund process fails in some scenarios</strong>
...
<li>The amount is now auto-filled for the prepayment, when doing prepayment on the POS from PAY button (reservation still in house).</li></ul></div>
