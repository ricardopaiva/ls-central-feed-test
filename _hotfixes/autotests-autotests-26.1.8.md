...
<div><strong>69853 SumAmountInclVATByCustomerOrderID calculates in LCY causing error creating Customer Orders</strong>
...
<ul><li>Fixed VAT calculation on Sales Order, created by Customer Order.</li></ul></div>
